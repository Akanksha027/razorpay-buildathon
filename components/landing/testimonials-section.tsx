...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "Profit Pilot auto-approved safe upsells and escalated the risky ones. We finally have an AI agent we can demo without holding our breath.",
      name: "A. Shah",
      company: "Merchant, Northstar Retail",
      image:
    ...
    {
      quote:
        "Dragging the margin floor mid-demo and watching the next checkout respond differently convinced the panel more than any slide deck.",
      name: "R. Kumar",
      company: "Ops Lead, Dessert Co.",
      image:
    ...
    {
      quote:
        "Seeing Gemini spend next to recovered revenue answered the commercial question before judges even asked it.",
      name: "S. Iyer",
      company: "Founder, Apex Apparel",
      image:
